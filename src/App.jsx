...
//     // Создаем зеленый квадрат в углу
...
//   const handleShiftMouseDown = (e, event, isPending) => {
//     // Только если зажат Ctrl или Shift
//     if (e.ctrlKey || e.shiftKey) {
//       e.preventDefault();
//       e.stopPropagation();
//       e.stopImmediatePropagation(); // Добавляем это для предотвращения других событий

//       // Убираем confirm и сразу копируем
//       handleCopyEvent(event, isPending, event.date);
//     }
//   };
...
//                     if (e.ctrlKey || e.shiftKey) {
//                       // Копирование при зажатом Ctrl/Shift
//                       handleCopyEvent(event, event.isPending, dateStr);
//                     } else if (isCopyMode) {
//                       // Копирование в режиме копирования
//                       handleCopyEvent(event, event.isPending, dateStr);
//                     } else {
